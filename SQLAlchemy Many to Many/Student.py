...
class Student(Base):
    ...
    def add_section(self, section):
        """
        Adds the section to the student's list of sections
        by adding an instance of Enrollments to the student.
        """
        for section in self.sections:
            if section == section:
                return
        student_section = Enrollments(section, self)

    def remove_section(self, section):
        """
        Removes the section from the student's list of sections
        by removing the instance of Enrollments from the student.
        """
        for section in self.sections:
            if section == section:
