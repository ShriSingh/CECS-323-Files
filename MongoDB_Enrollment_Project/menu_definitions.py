...
add_menu = Menu('add', 'Please indicate what you want to add:', [
    ...
    Option("Student to Section", "add_enrollment(sess)"),
...
list_menu = Menu('list', 'Please indicate what you want to list:', [
    ...
    Option("Course", "list_courses_by_department(db)"),
    Option("Section", "list_sections_by_course(db)"),
    ...
    Option("Student to Section", "list_enrollment(sess)"),
